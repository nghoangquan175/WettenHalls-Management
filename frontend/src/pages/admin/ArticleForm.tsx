    ...
    if (existingArticle.status === 'PUBLISHED') {
      return (
        <div className="flex flex-col items-center justify-center py-20">
          ...
          <p className="ContentMRegular text-gray-500 mb-6">
            You cannot edit an article that is already published.
          </p>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="ContentSRegular text-gray-400">
            ...
            <>
              ...
              {user?.role === 'SUPER_ADMIN' ? (
                <Button
                  ...
                  isLoading={
                    mutation.isPending && currentStatus === 'PUBLISHED'
                  }
                  disabled={mutation.isPending}
                >
                  Publish Now
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="space-y-2">
              <label className="ContentSBold text-gray-700">
                Article Title
              </label>
              <input
                type="text"
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm space-y-4">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center py-2 border-b border-gray-50">
                  ...
                  <span className="ContentSBold text-primary">
                    {currentStatus}
                  </span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-gray-50">
                  <span className="ContentSRegular text-gray-500">
                    Visibility
                  </span>
